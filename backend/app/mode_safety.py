...
MODE_SAFETY_CONFIG: dict[str, dict] = {
    ResearchMode.neoantigen: {
        ...
        "allowed_backends": [
            "mock", "colabfold", "local_colabfold", "alphafold2_local",
            "alphafold3_local", "alphafold_db", "boltz1", "boltz2",
            "esmfold", "openfold", "chai1",
        ],
        "prohibited_actions": [],
        "disclaimers": [
    ...
    ResearchMode.variant_pathogenicity: {
        ...
        "allowed_backends": [
            "mock", "colabfold", "local_colabfold", "alphafold2_local",
            "alphafold3_local", "alphafold_db", "alphafold_server",
            "boltz1", "boltz2", "esmfold", "openfold",
        ],
        "prohibited_actions": [],
        "disclaimers": [
    ...
    ResearchMode.antibody_design: {
        ...
        "allowed_backends": [
            "mock", "colabfold", "local_colabfold", "alphafold2_local",
            "alphafold3_local", "alphafold_db", "boltz1", "boltz2",
            "esmfold", "openfold", "rfdiffusion", "proteinmpnn", "chai1",
        ],
        "prohibited_actions": [
            "administer_to_humans_without_trial",
        ],
    ...
    ResearchMode.gene_therapy: {
        ...
        "allowed_backends": [
            "mock", "alphafold2_local", "alphafold3_local",
            "alphafold_db", "boltz1", "esmfold",
        ],
        "prohibited_actions": [
    ...
    ResearchMode.ppi_mapping: {
        ...
        "allowed_backends": [
            "mock", "colabfold", "local_colabfold", "alphafold2_local",
            "alphafold3_local", "alphafold_db", "alphafold_server",
            "boltz1", "boltz2", "esmfold", "openfold", "chai1",
        ],
        "prohibited_actions": [],
        "disclaimers": [
    ...
    ResearchMode.enzyme_engineering: {
        ...
        "allowed_backends": [
            "mock", "colabfold", "local_colabfold", "alphafold2_local",
            "alphafold3_local", "alphafold_db", "boltz1", "boltz2",
            "esmfold", "openfold", "rfdiffusion", "rfdiffusion2",
            "proteinmpnn",
        ],
        "prohibited_actions": [
    ...
    ResearchMode.protein_misfolding: {
        ...
        "allowed_backends": [
            "mock", "colabfold", "local_colabfold", "alphafold2_local",
            "alphafold3_local", "alphafold_db", "boltz1", "esmfold", "openfold",
        ],
        "prohibited_actions": [
...
def get_mode_config(mode: str) -> dict:
    ...
    try:
        ...
        raise KeyError(f"Unknown research mode: {mode!r}. Available: {[m.value for m in ResearchMode]}")
